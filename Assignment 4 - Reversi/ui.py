...
class Gui:
    ...
    def show_options(self):
        ...
        while True:
            ...
            title = title_fnt.render("Reversi", True, self.WHITE)
            ...
            level_txt = self.font.render("Select Computer Smartness", True, self.WHITE)
    ...
    def get_chosen_level(self):
        ...
        while True:
            self.screen.fill(self.BACKGROUND)
            title_fnt = pygame.font.SysFont("Times New Roman", 34)
            title = title_fnt.render("Select Level of Computer", True, self.WHITE)
            title_pos = title.get_rect(
                centerx=self.screen.get_width() / 2, centery=60)
            one_txt = self.font.render("Dummy", True, self.WHITE)
            one_pos = one_txt.get_rect(
                centerx=self.screen.get_width() / 2, centery=160)
            two_txt = self.font.render("Smart", True, self.WHITE)
            two_pos = two_txt.get_rect(
                centerx=self.screen.get_width() / 2, centery=240)

            three_txt = self.font.render("Intelligent", True, self.WHITE)
